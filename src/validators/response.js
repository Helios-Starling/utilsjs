import {
   ...
   * @property {'response'} type - Must be "response"
   * @property {string} requestId - UUID of the original request
   * @property {boolean} success - Whether the request was successful
   * @property {*} [data] - Response data (present if success is true)
   * @property {ResponseError} [error] - Error details (present if success is false)
   */
