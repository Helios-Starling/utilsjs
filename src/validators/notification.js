...
import {
   ...
   * @property {'notification'} type - Must be "notification"
   * @property {Object} notification - Notification content
   * @property {string} [notification.topic] - Optional routing topic
   * @property {*} notification.data - Notification data
   */
